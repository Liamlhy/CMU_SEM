...
public class summer{
	 static int findMaxCoverage(int shift[][], int numberLifeguards){
		 ...
		 //(Remove these number will contribute to total remove of coverage in such interval) 
		 ...
		 for (int i = 0; i < numberLifeguards; i++)
		    {
				...
				totalRemoved = single_number[end] - single_number[start];
		 ...
		 System.out.println("Maximum Total Coverage is " + totalMaxCoverage);
	 ...
	 public static void main(String args[]) throws Exception {
		 {
			 //Read in a file
			 File file = new File("/Users/liam/Downloads/6.in");
			...
			BufferedWriter writer = new BufferedWriter(new FileWriter("/Users/liam/Desktop/6.out"));
		    writer.write(output);
		    writer.close();
		    //Display output
		    File file2 = new File("/Users/liam/Desktop/6.out");
